...
export default function formatFields(schema, data, options = {}) {
  const {
    lang = 'fr',
    fieldSelection,
  } = options;
  ...
  if (fieldSelection && fieldSelection.includes('dateRange')) {
    fields.push(
      {
        dateRange: true,
        field: "dateRange",
  ...
  if (fieldSelection && fieldSelection.includes('location')) {
    fields.push(
      {
        location: true,
        field: "location",
  ...
  if (fieldSelection && fieldSelection.includes('registration')) {
